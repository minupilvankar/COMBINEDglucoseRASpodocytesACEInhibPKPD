...
% MAIN(drugname,renalfunction,pill_mg,num_doses_per_day,tfinal_dosing,sim_time_end, plot_mode,layer_plots,linestylestring,tstart_dosing,glu,linewidth,legendlocation,ANGII_Plot,plotcolor,kf,f )
